 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Samarth Wahal");
		  toPrint += p1.toString("swahal6");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Darrion Banks");
		  toPrint += p2.toString("gitdarrion");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Thomas Dantin");
		  toPrint += p3.toString("tdantin3");
          ...
          Person5 p5 = new Person5("Micah Terrell");
          toPrint += p5.toString("mterrell9");
          //Person5 replace P6 with your name
          //and gburdell6 with your gt id
          Person6 p6 = new Person6("Josh");
